...
import { Card, CardContent, Badge, Button, Dialog, DialogContent, DialogHeader, DialogTitle } from '../components/ui/primitives';
  ...
  return (
    <div className="p-4 space-y-6">
      <div className="text-center">
        ...
        <Badge variant="outline" className="border-[#008753] text-[#008753]">
          {roleConfig.name}
        </Badge>
      </div>
          ...
          <div className="space-y-2 py-4">
            {availableRoles.map((r) => (
              <button
                ...
                className={`w-full p-3 text-left rounded-lg text-sm ${
                  role === r
                    ? 'bg-[#008753]/10 text-[#008753] font-bold'
                    : 'hover:bg-gray-50'
                }`}
              >
